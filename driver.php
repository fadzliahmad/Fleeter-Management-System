                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Current registered driver information</p>
                                </div>

                                <div class="col-md-2">
                                	<a href="driver_add.php" class="btn btn-primary btn-round" role="button">Register new Driver</a>  
                                </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while($user_data = mysqli_fetch_array($result)){
                                            ...
                                            echo"<td>".$user_data['ic_number']."</td>";
                                            echo"<td>".$user_data['email']."</td>";
                                            echo"<td>".$user_data['address']."</td>";
                                            echo"<td>".$user_data['tel_number']."</td>";
                                            echo"<td>".$user_data['licenseexpiry']."</td>";
                                            echo"<td>".$user_data['licensetype']."</td>";
                                            echo"<td><a href ='driver_edit.php?id=$user_data[id]'>Edit</a> 
                                                     <a href='driver_delete.php?id=$user_data[id]' class='delete' data-confirm='Are you sure to delete this item?'>Delete</a></td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
