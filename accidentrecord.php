                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                            	...
                            	<div class="col-md-10">
                                <h4 class="title">Accidents Record</h4>
                                <p class="category">All Accident Records</p>
                                </div>

                                <div class="col-md-2">
                                	<a href="accident_add.php" class="btn btn-primary btn-round" role="button"><b>Add Accident Record</b></a>  
                                </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $result = mysqli_query($conn, "SELECT * FROM accident ORDER BY id ASC");
                                        ?>
                                        <?php
                                        ...
                                        <img src="upload/<?php echo $user_data['photo']?>" height="90" width="90">

                                        <?php echo "</td>";
                                            echo"<td>".$user_data['occur_date']."</td>";
                                            echo"<td>".$user_data['time']."</td>";
                                            echo"<td>".$user_data['model']."</td>";
                                            echo"<td>".$user_data['location']."</td>";
                                            echo"<td>".$user_data['driver']."</td>";
                                            echo"<td>".$user_data['injury']."</td>";
                                            echo"<td>".$user_data['description']."</td>";
                                            echo"<td><a href ='accident_edit.php?id=$user_data[id]'>Edit</a> | 
                                            <a href='accident_delete.php?id=$user_data[id]'class='delete' data-confirm='Are you sure to delete this item?'>Delete</a>
                                            </td>";
                                        }
                                        ?>
                                    </tbody>
