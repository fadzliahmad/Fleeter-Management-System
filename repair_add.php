                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        if(isset($_POST["submit1"])) {
                            ...
                            $result = mysqli_query($conn, "INSERT INTO repair (date1,type,repair_place,vehicle,meter_read,cost,remark,reference) VALUES ('$date','$type','$repair','$vehicle','$meterRead','$cost','$remark','$receipt')");
