    ...
    <div class="main-panel">
        ...
        <?php
			...
			<?php
				...
				$result = mysqli_query($conn, "SELECT * FROM maintenence WHERE id='$id'");
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                            ...
                            <h3 style="text-align: center;"><b>Update Maintenence Record</b></h3>
                            <p>Enter the following details :</p>

                            <form action="maintenence_edit.php" method="post">  
                            ...
                            <div class="form-group">
                              <label for="maintenencetype">Maintenence:</label>
                              <select class="form-control" name="maintenencetype">
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" name="supplier">
                                <option>Current:<?php echo $supplier; ?></option>
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" name="vehicle">
                                <option>Current: <?php echo $vehicle; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="meterread" value="<?php echo $meterRead; ?>" >
                            </div>
                            <div class="form-group">
                                <label>Cost :</label>
