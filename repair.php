		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Repairs</a>
                </div>
                     ...
                     <div class="card">
                        <div class="header">
                           <div class="col-md-10">
                              ...
                              <p class="category">Repair Record of Registered Vehicle</p>
                           </div>
                           <div class="col-md-2">
                              <a href="repair_add.php" class="btn btn-primary btn-round" role="button">Add Repair Record</a>  
                           </div>
                        </div>
                           ...
                           <table class="table table-hover table-striped">
                              ...
                              <tbody>
                                 <?php
                                    ...
                                    $result = mysqli_query($conn, "SELECT * FROM repair ORDER BY id DESC");
                                    ?>
                                 <?php
                                    while($user_data = mysqli_fetch_array($result)){
                                        ...
                                        echo"<td>".$user_data['repair_place']."</td>";
                                        ...
                                        echo"<td><a href ='repair_edit.php?id=$user_data[id]'>Edit</a>
                                                 <a href='repair_delete.php?id=$user_data[id]' class='delete' data-confirm='Are you sure to delete this item?'>Delete</a></td></tr>";
                                    }
                                    ?>
                              </tbody>
                           </table>
